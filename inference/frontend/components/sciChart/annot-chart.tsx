...
import commonClasses from "@/components/sciChart/sciChart.module.scss";
...
export default function UserAnnotatedStockChart() {
    ...
    const { sciChartSurfaceRef, chartControlsRef , candleDataSeriesRef, realtimeSeriesRef } = usePageContext();
            ...
            <div className={commonClasses.ChartWrapper}>
                <div className={classes.flexOuterContainer}>
                    ...
                    <SciChartReact
                        ...
                        initChart={(divElementId) => initializeCandleStickChart(divElementId, candleDataSeriesRef!, realtimeSeriesRef!)}
